...
import com.vivwe.faceunity.core.base.FUItem;
import com.vivwe.faceunity.core.base.FUItemHandler;
            ...
            public void run() {
                ...
                loadItem(expressionItem,
                        TextUtils.isEmpty(avatar.getExpressionFile()) ?
                                (avatar.getGender() == Constant.gender_boy ? (mIsNeedTrack ? POSE_ART_BOY : EXPRESSION_ART_BOY) : (mIsNeedTrack ? POSE_ART_GIRL : EXPRESSION_ART_GIRL))
