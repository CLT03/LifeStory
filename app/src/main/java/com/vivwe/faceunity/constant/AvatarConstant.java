package com.vivwe.faceunity.constant;

import com.vivwe.faceunity.entity.AvatarP2A;
import com.vivwe.faceunity.entity.BundleRes;
...
//
    ...
    public static BundleRes[] hairBundleRes(int gender) {
        return gender == Constant.gender_boy ? HAIR_ART_BOY : HAIR_ART_GIRL;
    }

    public static String[] hairBundle(String parent, int gender) {
        BundleRes[] hairs = gender == Constant.gender_boy ? HAIR_ART_BOY : HAIR_ART_GIRL;
    ...
    public static BundleRes[] glassesBundleRes(int gender) {
        return gender == Constant.gender_boy ? GLASSED_ART_BOY : GLASSED_ART_GIRL;
    }

    public static BundleRes[] clothesBundleRes(int gender) {
        return gender == Constant.gender_boy ? CLOTHES_ART_BOY : CLOTHES_ART_GIRL;
    }

    public static String bodyBundle(int gender) {
        return gender == Constant.gender_boy ? BODY_BUNDLE_ART_BOY : BODY_BUNDLE_ART_GIRL;
    }
    ...
    public static BundleRes[] hatBundleRes(int gender) {
        return gender == Constant.gender_boy ? HAT_ART_BOY : HAT_ART_GIRL;
    }

    public static BundleRes[] eyebrowBundleRes(int gender) {
        return gender == Constant.gender_boy ? EYEBROW_ART_BOY : EYEBROW_ART_GIRL;
    }
