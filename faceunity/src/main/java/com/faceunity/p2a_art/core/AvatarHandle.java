...
import com.faceunity.p2a_art.utils.EditFacePoint;
...
public class AvatarHandle extends BaseP2AHandle {
    ...
    public AvatarHandle(BaseCore baseCore, FUItemHandler FUItemHandler, final Runnable prepare) {
        ...
        mFUItemHandler.loadFUItem(FUItemHandler_what_controller, new com.faceunity.p2a_art.core.base.FUItemHandler.LoadFUItemListener(FUP2ARenderer.BUNDLE_controller) {
