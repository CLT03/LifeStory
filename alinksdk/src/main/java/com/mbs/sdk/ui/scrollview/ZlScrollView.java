package com.mbs.sdk.ui.scrollview;
...
public class ZlScrollView extends ScrollView {
    ...
    private static final int ANIM_TIME = 100;//松开手指后, 界面回到正常位置需要的动画时间
    private View contentView; //ScrollView的子View， 也是ScrollView的唯一一个子View
    ...
    private boolean isMoved = false;//在手指滑动的过程中记录是否移动了布局
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (shouldMove) {
                    int offset = (int) (deltaY * MOVE_FACTOR);//计算偏移量
                    //随着手指的移动而移动布局
