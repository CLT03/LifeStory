...
import com.mbs.sdk.ui.listview.pulllistview.adapter.BaseAdapter;
...
public class PullListView extends ListView implements Pullable {
    ...
    public void setAdapter(BaseAdapter adapter) {
        ...
        adapter.setOnScreen(new BaseAdapter.OnScreen() {
            @Override
            public int contentWidth() {
                return PullListView.this.getWidth();
            }

            @Override
            public int contentHeight() {
                return PullListView.this.getHeight();
            }
        });
