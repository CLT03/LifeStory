...
import com.mbs.sdk.ui.Menu.listener.OnTopMenuClick;
...
//			CLICK_RIGHT3 = R.id.id_menu_right3_icon, CLICK_RIGH_LABEL = R.id.id_menu_right_label;
	...
	private OnTopMenuClick listener;
	...
	public void setOnTopMenuClick(OnTopMenuClick listener) {
	...
	public void onClick(View v) {
		...
		int id = v.getId();
		if(id == R.id.id_left){
			listener.onClick(TopMenuTypeEnum.CLICK_LEFT, v);
		} else if(id == R.id.id_title){
			listener.onClick(TopMenuTypeEnum.CLICK_CENTER, v);
		} else if(id == R.id.id_menu_right1_icon){
			listener.onClick(TopMenuTypeEnum.CLICK_RIGHT1, v);
		} else if(id == R.id.id_menu_right2_icon){
			listener.onClick(TopMenuTypeEnum.CLICK_RIGHT2, v);
		} else if(id == R.id.id_menu_right3_icon){
			listener.onClick(TopMenuTypeEnum.CLICK_RIGHT3, v);
		} else if(id == R.id.id_menu_right_label){
			listener.onClick(TopMenuTypeEnum.CLICK_RIGH_LABEL, v);
		}
	}
