...
//	        	new AlertDialog(activity).setMessage(AlertDialog.CUSTOM, "您没有访问权限，点击")
	        	  
//	            Snackbar snackbar = Snackbar.make(activity.findViewById(R.id.btn_sdcard_avail), "这次是真的需要去授权了", Snackbar.LENGTH_LONG);
